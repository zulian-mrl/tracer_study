...
class KuesionerAlumniExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, WithCustomValueBinder
{
    protected $data;
        ...
        if (isset($this->data['alumniRaw'])) {
            foreach ($this->data['alumniRaw'] as $index => $alumni) {
                $rows[] = [
                    ...
                    $alumni->f502_bulan_dapat_kerja ?? $alumni->f502 ?? '0',
                    ...
                    $alumni->f5c_posisi_wiraswasta ?? $alumni->f5c ?? '0',
                    $alumni->f5d_tingkat_tempat_kerja ?? $alumni->f5d ?? '0',
                    ...
                    $alumni->f1702_A ?? $alumni->f1762 ?? '0',
                    $alumni->f1703_A ?? $alumni->f1763 ?? '0',
                    $alumni->f1704_A ?? $alumni->f1764 ?? '0',
                    $alumni->f1705_A ?? $alumni->f1765 ?? '0',
                    $alumni->f1706_A ?? $alumni->f1766 ?? '0',
                    $alumni->f1707_A ?? $alumni->f1767 ?? '0',
                    $alumni->f1701_B ?? $alumni->f1768 ?? '0',
                    $alumni->f1702_B ?? $alumni->f1769 ?? '0',
                    $alumni->f1703_B ?? $alumni->f1770 ?? '0',
                    $alumni->f1704_B ?? $alumni->f1771 ?? '0',
                    $alumni->f1705_B ?? $alumni->f1772 ?? '0',
                    $alumni->f1706_B ?? $alumni->f1773 ?? '0',
                    ...
                    strval($alumni->f6_perusahaan_dilamar),
                    strval($alumni->f7_perusahaan_merespon),
                    strval($alumni->f7a_mengundang_wawancara),
