...
class KuesionerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $belumBekerja = $request->input('f510_provinsi') === 'Belum Bekerja';
        $tempatKerjaTerisi = $this->tempatKerjaTerisi($request);
        $detailKerjaWajib = ! $belumBekerja && ($statusBekerja || ($statusLanjut && $tempatKerjaTerisi));
        $keselarasanWajib = $detailKerjaWajib;
        $kompAWajib = $statusBekerja || $statusTidakKerja || ($statusLanjut && $tempatKerjaTerisi);
        $kompBWajib = $detailKerjaWajib;
        $instansiLainnya = $request->input('f11_jenis_instansi') === '7';
        $caraLainnya = $request->has('f415');
        $keaktifanLainnya = $request->input('f10_aktif') === '5';
        $alasanLainnya = $request->has('f1613');
        $danaLainnya = $request->input('f12_01') === '7';
        ...
        $rules = [
            ...
            'f510_provinsi' => [Rule::requiredIf($detailKerjaWajib), 'nullable', 'string', 'max:60'],
            'f510_kab_kota' => [Rule::requiredIf($detailKerjaWajib), 'nullable', 'string', 'max:60'],
            'f11_jenis_instansi' => [Rule::requiredIf($detailKerjaWajib), 'nullable', Rule::in(['1', '2', '3', '4', '5', '6', '7'])],
            'f11_02' => [Rule::requiredIf($instansiLainnya), 'nullable', 'string', 'max:255'],
            'f5b_nama_perusahaan' => ['nullable', 'string', 'max:255'],
            'f5c_posisi' => [Rule::requiredIf($detailKerjaWajib), 'nullable', 'string', 'max:60'],
            'f5d_tingkat' => [Rule::requiredIf($detailKerjaWajib), 'nullable', 'string', 'max:60'],
            ...
            'f12_02' => [Rule::requiredIf($danaLainnya), 'nullable', 'string', 'max:255'],
            ...
            'f6_jumlah_lamaran' => ['required', 'integer', 'min:0'],
            'f7_jumlah_respons' => ['required', 'integer', 'min:0'],
            'f17a_jumlah_wawancara' => ['required', 'integer', 'min:0'],
            'f10_aktif' => ['required', Rule::in(['1', '2', '3', '4', '5'])],
            'f10_lainnya' => [Rule::requiredIf($keaktifanLainnya), 'nullable', 'string', 'max:255'],
            'f416_tuliskan' => [Rule::requiredIf($caraLainnya), 'nullable', 'string', 'max:255'],
            'f1614' => [Rule::requiredIf($alasanLainnya), 'nullable', 'string', 'max:255'],
        ];
        ...
        $request->validate($rules, [
            ...
            'f5c_posisi.required' => Setting::get('pesan_f5c', 'Pilih posisi/jabatan bila berwiraswasta.'),
            'f5d_tingkat.required' => Setting::get('pesan_f5d', 'Pilih tingkat tempat kerja Anda.'),
            ...
            'f6_jumlah_lamaran.required' => Setting::get('pesan_f6', 'Isi berapa perusahaan/instansi yang sudah Anda lamar.'),
            'f7_jumlah_respons.required' => Setting::get('pesan_f7', 'Isi berapa perusahaan/instansi yang merespons lamaran Anda.'),
            'f17a_jumlah_wawancara.required' => Setting::get('pesan_f17a', 'Isi berapa perusahaan/instansi yang mengundang Anda wawancara.'),
            'f11_02.required' => Setting::get('pesan_f11_lainnya', 'Tuliskan jenis perusahaan/instansi lainnya.'),
            'f416_tuliskan.required' => Setting::get('pesan_f416_lainnya', 'Tuliskan cara mencari kerja lainnya.'),
            'f10_lainnya.required' => Setting::get('pesan_f10_lainnya', 'Tuliskan jawaban lainnya.'),
            'f1614.required' => Setting::get('pesan_f1614_lainnya', 'Tuliskan alasan lainnya.'),
            'f12_02.required' => Setting::get('pesan_f12_lainnya', 'Tuliskan sumber dana kuliah lainnya.'),
        ]);
        ...
        try {
            DB::table('kuesioner_alumnis')->updateOrInsert(
                ...
                [
                    ...
                    'nik' => $nikInput,
                    'npwp' => $request->npwp,
                    'f8_status_saat_ini' => $request->f8_status_saat_ini,
                    'f504_mendapat_pekerjaan_6_bulan' => $request->f504_mendapat_pekerjaan_6_bulan,
                    ...
                    'f11_jenis_instansi' => ['1' => '1', '2' => '6', '3' => '7', '4' => '2', '5' => '3', '6' => '4', '7' => '5'][$request->f11_jenis_instansi] ?? $request->f11_jenis_instansi,
                    ...
                    'f12_sumber_biaya_kuliah' => $request->f12_01,
                    ...
                    'f14_erat_hubungan_studi' => $request->f14,
                    'f15_tingkat_paling_tepat' => $request->f15,
                    'f1701_A' => $request->f1761_f1762_A ?? $request->comp_a_f1761_f1762,
                    'f1702_A' => $request->f1763_f1764_A ?? $request->comp_a_f1763_f1764,
                    'f1703_A' => $request->f1765_f1766_A ?? $request->comp_a_f1765_f1766,
                    'f1704_A' => $request->f1767_f1768_A ?? $request->comp_a_f1767_f1768,
                    'f1705_A' => $request->f1769_f1770_A ?? $request->comp_a_f1769_f1770,
                    'f1706_A' => $request->f1771_f1772_A ?? $request->comp_a_f1771_f1772,
                    'f1707_A' => $request->f1773_f1774_A ?? $request->comp_a_f1773_f1774,

                    'f1701_B' => $request->f1761_f1762_B ?? $request->comp_b_f1761_f1762,
                    'f1702_B' => $request->f1763_f1764_B ?? $request->comp_b_f1763_f1764,
                    'f1703_B' => $request->f1765_f1766_B ?? $request->comp_b_f1765_f1766,
                    'f1704_B' => $request->f1767_f1768_B ?? $request->comp_b_f1767_f1768,
                    'f1705_B' => $request->f1769_f1770_B ?? $request->comp_b_f1769_f1770,
                    'f1706_B' => $request->f1771_f1772_B ?? $request->comp_b_f1771_f1772,
                    'f1707_B' => $request->f1773_f1774_B ?? $request->comp_b_f1773_f1774,

                    'created_at' => now(),
                    'updated_at' => now(),

                    'f21_perkuliahan' => $request->f21 ?? $request->f21_perkuliahan,
                    'f22_demonstrasi' => $request->f22 ?? $request->f22_demonstrasi,
                    'f23_riset' => $request->f23 ?? $request->f23_riset,
                    'f24_magang' => $request->f24 ?? $request->f24_magang,
                    'f25_praktikum' => $request->f25 ?? $request->f25_praktikum,
                    'f26_kerja_lapangan' => $request->f26 ?? $request->f26_kerja_lapangan,
                    'f27_diskusi' => $request->f27 ?? $request->f27_diskusi,
                    'f301_kapan_mencari_pekerjaan' => $request->f301,
                    ...
                    'f10_aktif_mencari_kerja' => $request->f10_aktif,
